...
public class ItemDAOImpl implements ItemDAO {
    ...
    public boolean add(Item entity) throws SQLException, ClassNotFoundException {
        return CrudUtil.execute("INSERT INTO Item (item_id, type, qty_on_hand, unit_price) VALUES (?,?,?,?)",entity.getId(),entity.getType(),entity.getUnitPrice(),entity.getQtyOnHand());
    }

    @Override
    public boolean update(Item entity) throws SQLException, ClassNotFoundException {
        return CrudUtil.execute("UPDATE Item SET type=?, qty_on_Hand=?, unit_price=? WHERE code=?",entity.getType(),entity.getUnitPrice(),entity.getQtyOnHand(),entity.getId());
    }
    ...
    public String generateNewId() throws SQLException, ClassNotFoundException {
        ...
        if (rst.next()) {
            ...
            int newItemId = Integer.parseInt(id.replace("I000", "")) + 1;
